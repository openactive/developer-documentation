...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>DEPRECATED: Please use <code>oa:ageRestriction</code> instead when describing
          an <code>Offer</code>.</p>
        <p>
          <br /><b>Example</b>
        </p>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>Indicates that an Offer is only applicable to a specific age range. Specified
          as a QuantitativeValue with minValue and maxValue properties. This must
          be displayed prominently to the user when selecting an <code>Offer</code> or
          before booking.</p>
        <p>
          <br /><b>Example</b>
        </p>
