...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p><b>DEPRECATED</b>: Use <code>ageRestriction</code> instead of <code>ageRange</code> within
          the <code>Offer</code> for cases where the <code>Offer</code> is age restricted.</p>
        <p>Indicates that an Offer is only applicable to a specific age range.</p>
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">
        <p>Indicates that an Offer can only be purchased by participants within a
          specific age range. Specified as a QuantitativeValue with minValue and
          maxValue properties. This must be displayed prominently to the user when
          selecting an <code>Offer</code> or before booking.</p>
        <p>
          <br /><b>Example</b>
        </p>
    ...
    <tr>
      <td style="text-align:left"><b>allowCustomerCancellationFullRefund</b>
      </td>
      <td style="text-align:left"> <a href="https://schema.org/Boolean"><code>Boolean</code></a>
      </td>
      <td style="text-align:left">Whether the opportunity can be cancelled with a full refund at any time
        before the <code>startDate</code>, or before the <code>latestCancellationBeforeStartDate</code> if
        provided.</td>
    </tr>
    <tr>
    ...
    <tr>
      <td style="text-align:left"><b>openBookingInAdvance</b>
      </td>
      ...
      <td style="text-align:left">
        ...
        <p><code>&quot;openBookingInAdvance&quot;: &quot;https://openactive.io/Required&quot;</code>
        </p>
      </td>
    </tr>
    <tr>
      <td style="text-align:left"><b>openBookingPrepayment</b>
      </td>
      <td style="text-align:left"> <a href="https://openactive.io/RequiredStatusType"><code>RequiredStatusType</code></a>
      </td>
      <td style="text-align:left">
        ...
        <p><code>&quot;openBookingPrepayment&quot;: &quot;https://openactive.io/Required&quot;</code>
        </p>
      </td>
    </tr>
    <tr>
