  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p><code>&quot;@id&quot;: &quot;https://id.bookingsystem.example.com/places/12345&quot;</code>
        </p>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>A plain text description of the Place, which must not include HTML or
          other markup.</p>
        <p>
          <br /><b>Example</b>
        </p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td style="text-align:left"><b>specialOpeningHoursSpecification</b>
      </td>
      <td style="text-align:left">Array of <a href="https://developer.openactive.io/data-model/types/openinghoursspecification"><code>OpeningHoursSpecification</code></a>
      </td>
      <td style="text-align:left">Explicitly override general opening hours brought in scope by <code>schema:openingHoursSpecification</code>.</td>
    </tr>
  </tbody>
</table>
