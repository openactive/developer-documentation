...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">Must always be present and set to <code>&quot;type&quot;: &quot;Lease&quot;</code>
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">
        <p>Optional identifier of the Lease if useful for audit or debugging purposes.</p>
        <p>
          <br /><b>Example</b>
        </p>
    ...
    <tr>
      <td style="text-align:left"><b>leaseExpires</b>
      </td>
      <td style="text-align:left"> <a href="https://schema.org/DateTime"><code>DateTime</code></a>
      </td>
      <td style="text-align:left">Expiry DateTime of the Lease in ISO 8601 format</td>
    </tr>
  </tbody>
