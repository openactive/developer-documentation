...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">
        Must always be present and set to <code>"@type": "InternalApplicationError"</code>
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>A short, human-readable summary of the problem type. It should not change from occurrence to occurrence of the problem, except for purposes of localization.</p><p></br><b>Example</b></p><p><code>"name": "An unexpected exception has been thrown by the application."</code></p>
      </td>
    </tr>
  </tbody>
</table>
