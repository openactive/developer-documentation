  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left"> <a href="https://developer.openactive.io/data-model/types/facilityuse"><code>FacilityUse</code></a>
        <br
        />- or -
        <br /><a href="https://developer.openactive.io/data-model/types/individualfacilityuse"><code>IndividualFacilityUse</code></a>
        <br
        />- or -
        <br /><a href="https://schema.org/URL"><code>URL</code></a>
      </td>
      <td style="text-align:left">
        <p>FacilityUse or IndividualFacilityUse that has this offer, either directly
          embedded or referenced by its @id</p>
        <p>
          <br /><b>Example</b>
        </p>
