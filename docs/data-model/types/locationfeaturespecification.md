...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">
        Must always be present and set to <code>"@type": "LocationFeatureSpecification"</code>
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">
        <p>A string, suitable for presentation in user interfaces.</p><p></br><b>Example</b></p><p><code>"name": "Bike Shed"</code></p>
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">
        <p>A boolean value indicating whether this ammenity is available.</p>
      </td>
    </tr>
  </tbody>
</table>
