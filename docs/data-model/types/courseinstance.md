  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p>It is recommended that locations should be specified as a <a href="https://github.com/openactive/developer-documentation/tree/de7191d8ac171b7fac1d6107416e7263a2c2948a/models/place/README.md">Place</a> complete
          with a fully described geographic location and/or address.</p>
        <p>If only an address is available then this should be described as a <a href="https://github.com/openactive/developer-documentation/tree/de7191d8ac171b7fac1d6107416e7263a2c2948a/models/postaladdress/README.md">PostalAddress</a>.</p>
