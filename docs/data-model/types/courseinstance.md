  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p>It is recommended that locations should be specified as a <a href="https://github.com/openactive/developer-documentation/tree/74cc1712f3a179bde43f019f2a1600d5224c7204/models/place/README.md">Place</a> complete
          with a fully described geographic location and/or address.</p>
        <p>If only an address is available then this should be described as a <a href="https://github.com/openactive/developer-documentation/tree/74cc1712f3a179bde43f019f2a1600d5224c7204/models/postaladdress/README.md">PostalAddress</a>.</p>
