  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p>It is recommended that locations should be specified as a <a href="https://github.com/openactive/developer-documentation/tree/39a8a88d0dd7bccfb7ecad8cf3e4bd8fb9eeeccf/models/place/README.md">Place</a> complete
          with a fully described geographic location and/or address.</p>
        <p>If only an address is available then this should be described as a <a href="https://github.com/openactive/developer-documentation/tree/39a8a88d0dd7bccfb7ecad8cf3e4bd8fb9eeeccf/models/postaladdress/README.md">PostalAddress</a>.</p>
