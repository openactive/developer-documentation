...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">
        Must always be present and set to <code>"@type": "Towels"</code>
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">
        <p>A string, suitable for presentation in user interfaces.</p><p></br><b>Example</b></p><p><code>"name": "Complementary Towels"</code></p>
      </td>
    </tr>
    <tr>
