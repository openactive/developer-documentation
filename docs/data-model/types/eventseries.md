...
This type is derived from [https://schema.org/EventSeries](https://schema.org/EventSeries), which means that any of this type's properties within schema.org may also be used. Note however the properties on this page must be used in preference if a relevant property is available.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p>It is recommended that locations should be specified as a <a href="https://github.com/openactive/developer-documentation/tree/a283248574359348d2251740e771e9c0c2f881e7/models/place/README.md">Place</a> complete
          with a fully described geographic location and/or address.</p>
        <p>If only an address is available then this should be described as a <a href="https://github.com/openactive/developer-documentation/tree/a283248574359348d2251740e771e9c0c2f881e7/models/postaladdress/README.md">PostalAddress</a>.</p>
