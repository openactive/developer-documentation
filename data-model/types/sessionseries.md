...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>TODO</p><br/></br></br><b>Example</b></br></br><code>{}</code>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>Relates a parent event to a child event. Properties describing the parent event can be assumed to apply to the child, unless otherwise specified. A child event might be a specific instance of an Event within a schedule</p><br/>
      </td>
    </tr>
    <tr>
