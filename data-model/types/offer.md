...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>The offer price of the activity.</p><p>This price should be specified without currency symbols and as a floating point number with two decimal places.</p><p>The currency of the price should be expressed in the priceCurrency field.</p><p></br><b>Example</b></p><p><code>33</code></p>
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">
        <p>A unique url based identifier for the record</p><p></br><b>Example</b></p><p><code>https://example.com/offer/1234</code></p>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>A human readable name for the offer.</p><p></br><b>Example</b></p><p><code>Speedball winger position</code></p>
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">
        <p>The currency (in 3-letter ISO 4217 format) of the price.</p><p>If an Offer has a zero price, then this property is not required. Otherwise the currency must be specified.</p><p></br><b>Example</b></p><p><code>GBP</code></p>
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">
        <p>URL describing the offer</p><p></br><b>Example</b></p><p><code>http://www.rphs.org.uk/</code></p>
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">
        <p>Indicates whether to accept this offer, a participant must book in advance, whether they must pay on attending, or have option to do either.</p><p></br><b>Example</b></p><p><code>https://openactive.io/Required</code></p>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>Indicates whether to accept this offer, a participant must pay in advance, pay when attending, or have the option to do either.</p><p></br><b>Example</b></p><p><code>https://openactive.io/Required</code></p>
      </td>
    </tr>
  </tbody>
</table>
