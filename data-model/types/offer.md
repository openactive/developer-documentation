...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>The offer price of the activity.</p><br/></br></br><p>This price should be specified without currency symbols and as a floating point number with two decimal places.</p><br/></br></br><p>The currency of the price should be expressed in the priceCurrency field.</p><br/></br></br><b>Example</b></br></br><code>33</code>
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">
        <p>A unique url based identifier for the record</p><br/></br></br><b>Example</b></br></br><code>https://example.com/offer/1234</code>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>A human readable name for the offer.</p><br/></br></br><b>Example</b></br></br><code>Speedball winger position</code>
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">
        <p>The currency (in 3-letter ISO 4217 format) of the price.</p><br/></br></br><p>If an Offer has a zero price, then this property is not required. Otherwise the currency must be specified.</p><br/></br></br><b>Example</b></br></br><code>GBP</code>
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">
        <p>URL describing the offer</p><br/></br></br><b>Example</b></br></br><code>http://www.rphs.org.uk/</code>
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">
        <p>Indicates whether to accept this offer, a participant must book in advance, whether they must pay on attending, or have option to do either.</p><br/></br></br><b>Example</b></br></br><code>https://openactive.io/Required</code>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>Indicates whether to accept this offer, a participant must pay in advance, pay when attending, or have the option to do either.</p><br/></br></br><b>Example</b></br></br><code>https://openactive.io/Required</code>
      </td>
    </tr>
  </tbody>
</table>
